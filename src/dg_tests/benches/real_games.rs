...
fn play_moves(moves: &[(dg_go::Color, usize, usize)]) -> Board {
...
const RINA_FUJISAWA_JEONG_CHIO: [(dg_go::Color, usize, usize); 232] = [
...
fn playout(b: &mut Bencher) {
    b.iter(|| {
        play_moves(&RINA_FUJISAWA_JEONG_CHIO)
    });
}

const LEE_SEDOL_ALPHAGO_4_78: [(dg_go::Color, usize, usize); 78] = [
...
const RINA_FUJISAWA_ZHIYING_YU: [(dg_go::Color, usize, usize); 135] = [
