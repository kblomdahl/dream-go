...
#define __PYX_HAVE__dream_net__sgf
#define __PYX_HAVE_API__dream_net__sgf
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'dream_net.sgf' */
static double __pyx_f_9dream_net_3sgf_random(void); /*proto*/
static void __pyx_f_9dream_net_3sgf__augment_coordinate(int, int, int *, int, int, int *); /*proto*/
static int __pyx_f_9dream_net_3sgf_gather_moves(unsigned char const *, int const , int *, int *, int *, int *); /*proto*/
static int __pyx_f_9dream_net_3sgf__one(unsigned char const *, int const , struct __pyx_obj_9dream_net_5rules_5board_Board *, int *, int *, int *); /*proto*/
#define __Pyx_MODULE_NAME "dream_net.sgf"
extern int __pyx_module_is_main_dream_net__sgf;
int __pyx_module_is_main_dream_net__sgf = 0;

/* Implementation of 'dream_net.sgf' */
...
static const char __pyx_k_line_ptr[] = "line_ptr";
static const char __pyx_k_ValueError[] = "ValueError";
static const char __pyx_k_pyx_vtable[] = "__pyx_vtable__";
static const char __pyx_k_ImportError[] = "ImportError";
static const char __pyx_k_line_length[] = "line_length";
static const char __pyx_k_next1_color[] = "next1_color";
static const char __pyx_k_RuntimeError[] = "RuntimeError";
static const char __pyx_k_next1_logits[] = "next1_logits";
static const char __pyx_k_dream_net_sgf[] = "dream_net.sgf";
static const char __pyx_k_dream_net_sgf_pyx[] = "dream_net/sgf.pyx";
...
static PyObject *__pyx_n_s_dream_net_sgf;
static PyObject *__pyx_kp_s_dream_net_sgf_pyx;
static PyObject *__pyx_n_s_f2;
static PyObject *__pyx_n_s_import;
static PyObject *__pyx_n_s_line;
static PyObject *__pyx_n_s_line_length;
static PyObject *__pyx_n_s_line_ptr;
static PyObject *__pyx_n_s_main;
static PyObject *__pyx_kp_u_ndarray_is_not_C_contiguous;
static PyObject *__pyx_kp_u_ndarray_is_not_Fortran_contiguou;
static PyObject *__pyx_n_s_next1_color;
static PyObject *__pyx_n_s_next1_logits;
...
static PyObject *__pyx_pf_9dream_net_3sgf_one(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_line); /* proto */
...
static double __pyx_f_9dream_net_3sgf_random(void) {
  double __pyx_r;
  double __pyx_t_1;
  double __pyx_t_2;

  /* "dream_net/sgf.pyx":11
 * 
 * cdef double random() nogil:
 *     return <double>rand() / (<double>RAND_MAX + 1.0)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("dream_net.sgf.random", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_r = 0;
  __pyx_L0:;
  return __pyx_r;
}

/* "dream_net/sgf.pyx":14
 * 
 * @cython.boundscheck(False)
 * cdef void _augment_coordinate(int xx, int xy, int *x, int yx, int yy, int *y) nogil:             # <<<<<<<<<<<<<<
 *     cdef int x_ = x[0]
 *     cdef int y_ = y[0]
 */

static void __pyx_f_9dream_net_3sgf__augment_coordinate(int __pyx_v_xx, int __pyx_v_xy, int *__pyx_v_x, int __pyx_v_yx, int __pyx_v_yy, int *__pyx_v_y) {
  int __pyx_v_x_;
  int __pyx_v_y_;
  int __pyx_v_cx;
  int __pyx_v_cy;

  /* "dream_net/sgf.pyx":15
 * @cython.boundscheck(False)
 * cdef void _augment_coordinate(int xx, int xy, int *x, int yx, int yy, int *y) nogil:
 *     cdef int x_ = x[0]             # <<<<<<<<<<<<<<
 *     cdef int y_ = y[0]
 *     cdef int cx = x_ - 9
 */
  __pyx_v_x_ = (__pyx_v_x[0]);

  /* "dream_net/sgf.pyx":16
 * cdef void _augment_coordinate(int xx, int xy, int *x, int yx, int yy, int *y) nogil:
 *     cdef int x_ = x[0]
 *     cdef int y_ = y[0]             # <<<<<<<<<<<<<<
 *     cdef int cx = x_ - 9
 *     cdef int cy = y_ - 9
 */
  __pyx_v_y_ = (__pyx_v_y[0]);

  /* "dream_net/sgf.pyx":17
 *     cdef int x_ = x[0]
 *     cdef int y_ = y[0]
 *     cdef int cx = x_ - 9             # <<<<<<<<<<<<<<
 *     cdef int cy = y_ - 9
 * 
 */
  __pyx_v_cx = (__pyx_v_x_ - 9);

  /* "dream_net/sgf.pyx":18
 *     cdef int y_ = y[0]
 *     cdef int cx = x_ - 9
 *     cdef int cy = y_ - 9             # <<<<<<<<<<<<<<
 * 
 *     x[0] = 9 + (xx * cx + xy * cy)
 */
  __pyx_v_cy = (__pyx_v_y_ - 9);

  /* "dream_net/sgf.pyx":20
 *     cdef int cy = y_ - 9
 * 
 *     x[0] = 9 + (xx * cx + xy * cy)             # <<<<<<<<<<<<<<
 *     y[0] = 9 + (yx * cx + yy * cy)
 * 
 */
  (__pyx_v_x[0]) = (9 + ((__pyx_v_xx * __pyx_v_cx) + (__pyx_v_xy * __pyx_v_cy)));

  /* "dream_net/sgf.pyx":21
 * 
 *     x[0] = 9 + (xx * cx + xy * cy)
 *     y[0] = 9 + (yx * cx + yy * cy)             # <<<<<<<<<<<<<<
 * 
 * 
 */
  (__pyx_v_y[0]) = (9 + ((__pyx_v_yx * __pyx_v_cx) + (__pyx_v_yy * __pyx_v_cy)));
...
/* "dream_net/sgf.pyx":25
 * 
 * @cython.boundscheck(False)
 * cdef void augment_coordinate(int s, int *x, int *y) nogil:             # <<<<<<<<<<<<<<
 *     if s == 0:  # identity
 *         pass
 */

static void __pyx_f_9dream_net_3sgf_augment_coordinate(int __pyx_v_s, int *__pyx_v_x, int *__pyx_v_y) {

  /* "dream_net/sgf.pyx":26
 * @cython.boundscheck(False)
 * cdef void augment_coordinate(int s, int *x, int *y) nogil:
 *     if s == 0:  # identity             # <<<<<<<<<<<<<<
 *         pass
 ...
 */
  switch (__pyx_v_s) {
    ...
    /* "dream_net/sgf.pyx":28
 *     if s == 0:  # identity
 *         pass
 *     elif s == 1:  # flip across horizontal axis             # <<<<<<<<<<<<<<
 *         _augment_coordinate(-1, 0, x, 0, 1, y)
 *     elif s == 2:  # flip across the vertical axis
 */
    case 1:

    /* "dream_net/sgf.pyx":29
 *         pass
 *     elif s == 1:  # flip across horizontal axis
 *         _augment_coordinate(-1, 0, x, 0, 1, y)             # <<<<<<<<<<<<<<
 *     elif s == 2:  # flip across the vertical axis
 *         _augment_coordinate(1, 0, x, 0, -1, y)
 */
    __pyx_f_9dream_net_3sgf__augment_coordinate(-1, 0, __pyx_v_x, 0, 1, __pyx_v_y);
 ...
 */
    ...
    /* "dream_net/sgf.pyx":31
 *         _augment_coordinate(-1, 0, x, 0, 1, y)
 *     elif s == 2:  # flip across the vertical axis
 *         _augment_coordinate(1, 0, x, 0, -1, y)             # <<<<<<<<<<<<<<
 *     elif s == 3:  # flip across the main diagonal
 *         _augment_coordinate(0, 1, x, 1, 0, y)
 */
    __pyx_f_9dream_net_3sgf__augment_coordinate(1, 0, __pyx_v_x, 0, -1, __pyx_v_y);
 ...
 *         _augment_coordinate(0, -1, x, -1, 0, y)
 */
    __pyx_f_9dream_net_3sgf__augment_coordinate(0, 1, __pyx_v_x, 1, 0, __pyx_v_y);
...
static int __pyx_f_9dream_net_3sgf_gather_moves(unsigned char const *__pyx_v_line, int const __pyx_v_line_length, int *__pyx_v_color, int *__pyx_v_x, int *__pyx_v_y, int *__pyx_v_winner) {
  int __pyx_v_i;
  int __pyx_v_resigned;
  int __pyx_v_count;
  int __pyx_r;
  int __pyx_t_1;
  int __pyx_t_2;
 ...
 */
  while (1) {
    __pyx_t_1 = ((__pyx_v_i < __pyx_v_line_length) != 0);
    if (!__pyx_t_1) break;

    /* "dream_net/sgf.pyx":70
 *     #
 *     while i < line_length:
 *         if line[i] == 66 and line[i-1] == 91 and line[i-2] == 69 and line[i-3] == 82:  # RE[B             # <<<<<<<<<<<<<<
 *             winner[0] = BLACK
 ...
 */
    __pyx_t_2 = (((__pyx_v_line[__pyx_v_i]) == 66) != 0);
    if (__pyx_t_2) {
    } else {
      __pyx_t_1 = __pyx_t_2;
      goto __pyx_L6_bool_binop_done;
    }
    __pyx_t_2 = (((__pyx_v_line[(__pyx_v_i - 1)]) == 91) != 0);
    if (__pyx_t_2) {
    } else {
      __pyx_t_1 = __pyx_t_2;
      goto __pyx_L6_bool_binop_done;
    }
    __pyx_t_2 = (((__pyx_v_line[(__pyx_v_i - 2)]) == 69) != 0);
    if (__pyx_t_2) {
    } else {
      __pyx_t_1 = __pyx_t_2;
      goto __pyx_L6_bool_binop_done;
    }
    __pyx_t_2 = (((__pyx_v_line[(__pyx_v_i - 3)]) == 82) != 0);
    __pyx_t_1 = __pyx_t_2;
    __pyx_L6_bool_binop_done:;
    if (__pyx_t_1) {

      /* "dream_net/sgf.pyx":71
 *     while i < line_length:
 *         if line[i] == 66 and line[i-1] == 91 and line[i-2] == 69 and line[i-3] == 82:  # RE[B
 *             winner[0] = BLACK             # <<<<<<<<<<<<<<
 *         elif line[i] == 87 and line[i-1] == 91 and line[i-2] == 69 and line[i-3] == 82:  # RE[W
 *             winner[0] = WHITE
 */
      (__pyx_v_winner[0]) = __pyx_v_9dream_net_5rules_5color_BLACK;
 ...
 */
    __pyx_t_2 = (((__pyx_v_line[__pyx_v_i]) == 87) != 0);
    if (__pyx_t_2) {
    } else {
      __pyx_t_1 = __pyx_t_2;
 ...
 */
      (__pyx_v_winner[0]) = __pyx_v_9dream_net_5rules_5color_WHITE;
 ...
 *                 x[count] = line[i-2] - 97
 */
    __pyx_t_2 = (((__pyx_v_line[__pyx_v_i]) == 93) != 0);
    if (__pyx_t_2) {
    } else {
      __pyx_t_1 = __pyx_t_2;
      goto __pyx_L14_bool_binop_done;
    }
    __pyx_t_2 = (((__pyx_v_line[(__pyx_v_i - 3)]) == 91) != 0);
    if (__pyx_t_2) {
    } else {
      __pyx_t_1 = __pyx_t_2;
      goto __pyx_L14_bool_binop_done;
    }
    __pyx_t_2 = (((__pyx_v_line[(__pyx_v_i - 5)]) == 59) != 0);
    __pyx_t_1 = __pyx_t_2;
    __pyx_L14_bool_binop_done:;
    if (__pyx_t_1) {

      /* "dream_net/sgf.pyx":75
 *             winner[0] = WHITE
 *         elif line[i] == 93 and line[i-3] == 91 and line[i-5] == 59:  # `;?[??]`
 *             if line[i-4] == 66 or line[i-4] == 87:  # `;B[??]` or `;W[??]`             # <<<<<<<<<<<<<<
 *                 x[count] = line[i-2] - 97
 *                 y[count] = line[i-1] - 97
 */
      __pyx_t_2 = (((__pyx_v_line[(__pyx_v_i - 4)]) == 66) != 0);
      if (!__pyx_t_2) {
      } else {
        __pyx_t_1 = __pyx_t_2;
        goto __pyx_L18_bool_binop_done;
      }
      __pyx_t_2 = (((__pyx_v_line[(__pyx_v_i - 4)]) == 87) != 0);
      __pyx_t_1 = __pyx_t_2;
      __pyx_L18_bool_binop_done:;
      if (__pyx_t_1) {

        /* "dream_net/sgf.pyx":76
 *         elif line[i] == 93 and line[i-3] == 91 and line[i-5] == 59:  # `;?[??]`
 *             if line[i-4] == 66 or line[i-4] == 87:  # `;B[??]` or `;W[??]`
 *                 x[count] = line[i-2] - 97             # <<<<<<<<<<<<<<
 *                 y[count] = line[i-1] - 97
 ...
 */
        (__pyx_v_x[__pyx_v_count]) = ((__pyx_v_line[(__pyx_v_i - 2)]) - 97);

        /* "dream_net/sgf.pyx":77
 *             if line[i-4] == 66 or line[i-4] == 87:  # `;B[??]` or `;W[??]`
 *                 x[count] = line[i-2] - 97
 *                 y[count] = line[i-1] - 97             # <<<<<<<<<<<<<<
 *                 color[count] = BLACK if line[i-4] == 66 else WHITE
 *                 count += 1
 */
        (__pyx_v_y[__pyx_v_count]) = ((__pyx_v_line[(__pyx_v_i - 1)]) - 97);

        /* "dream_net/sgf.pyx":78
 *                 x[count] = line[i-2] - 97
 *                 y[count] = line[i-1] - 97
 *                 color[count] = BLACK if line[i-4] == 66 else WHITE             # <<<<<<<<<<<<<<
 *                 count += 1
 ...
 */
        if ((((__pyx_v_line[(__pyx_v_i - 4)]) == 66) != 0)) {
          __pyx_t_3 = __pyx_v_9dream_net_5rules_5color_BLACK;
        } else {
          __pyx_t_3 = __pyx_v_9dream_net_5rules_5color_WHITE;
        }
        (__pyx_v_color[__pyx_v_count]) = __pyx_t_3;

        /* "dream_net/sgf.pyx":79
 *                 y[count] = line[i-1] - 97
 *                 color[count] = BLACK if line[i-4] == 66 else WHITE
 *                 count += 1             # <<<<<<<<<<<<<<
 *         elif line[i] == 93 and line[i-1] == 91 and line[i-3] == 59:  # `;?[]`
 ...
 */
    ...
    __pyx_t_2 = (((__pyx_v_line[(__pyx_v_i - 3)]) == 59) != 0);
    __pyx_t_1 = __pyx_t_2;
    __pyx_L20_bool_binop_done:;
    if (__pyx_t_1) {

      /* "dream_net/sgf.pyx":81
 *                 count += 1
 *         elif line[i] == 93 and line[i-1] == 91 and line[i-3] == 59:  # `;?[]`
 *             if line[i-2] == 66 or line[i-2] == 87:  # `;B[]` or `;W[]`             # <<<<<<<<<<<<<<
 *                 x[count] = 19
 *                 y[count] = 19
 */
      __pyx_t_2 = (((__pyx_v_line[(__pyx_v_i - 2)]) == 66) != 0);
      if (!__pyx_t_2) {
      } else {
        __pyx_t_1 = __pyx_t_2;
        goto __pyx_L24_bool_binop_done;
      }
      __pyx_t_2 = (((__pyx_v_line[(__pyx_v_i - 2)]) == 87) != 0);
      __pyx_t_1 = __pyx_t_2;
      __pyx_L24_bool_binop_done:;
      if (__pyx_t_1) {

        /* "dream_net/sgf.pyx":82
 *         elif line[i] == 93 and line[i-1] == 91 and line[i-3] == 59:  # `;?[]`
 *             if line[i-2] == 66 or line[i-2] == 87:  # `;B[]` or `;W[]`
 *                 x[count] = 19             # <<<<<<<<<<<<<<
 *                 y[count] = 19
 ...
 */
        (__pyx_v_x[__pyx_v_count]) = 19;

        /* "dream_net/sgf.pyx":83
 *             if line[i-2] == 66 or line[i-2] == 87:  # `;B[]` or `;W[]`
 *                 x[count] = 19
 *                 y[count] = 19             # <<<<<<<<<<<<<<
 *                 color[count] = BLACK if line[i-2] == 66 else WHITE
 *                 count += 1
 */
        (__pyx_v_y[__pyx_v_count]) = 19;

        /* "dream_net/sgf.pyx":84
 *                 x[count] = 19
 *                 y[count] = 19
 *                 color[count] = BLACK if line[i-2] == 66 else WHITE             # <<<<<<<<<<<<<<
 *                 count += 1
 ...
 */
        if ((((__pyx_v_line[(__pyx_v_i - 2)]) == 66) != 0)) {
          __pyx_t_3 = __pyx_v_9dream_net_5rules_5color_BLACK;
        } else {
          __pyx_t_3 = __pyx_v_9dream_net_5rules_5color_WHITE;
        }
 ...
 * 
 */
    __pyx_t_2 = (((__pyx_v_line[__pyx_v_i]) == 0x64) != 0);
    if (__pyx_t_2) {
    } else {
      __pyx_t_1 = __pyx_t_2;
      goto __pyx_L26_bool_binop_done;
    }
    __pyx_t_2 = (((__pyx_v_line[(__pyx_v_i - 1)]) == 0x67) != 0);
    if (__pyx_t_2) {
    } else {
      __pyx_t_1 = __pyx_t_2;
      goto __pyx_L26_bool_binop_done;
    }
    __pyx_t_2 = (((__pyx_v_line[(__pyx_v_i - 2)]) == 0x69) != 0);
    if (__pyx_t_2) {
    } else {
      __pyx_t_1 = __pyx_t_2;
      goto __pyx_L26_bool_binop_done;
    }
    __pyx_t_2 = (((__pyx_v_line[(__pyx_v_i - 3)]) == 0x73) != 0);
    if (__pyx_t_2) {
    } else {
      __pyx_t_1 = __pyx_t_2;
      goto __pyx_L26_bool_binop_done;
    }
    __pyx_t_2 = (((__pyx_v_line[(__pyx_v_i - 4)]) == 0x65) != 0);
    if (__pyx_t_2) {
    } else {
      __pyx_t_1 = __pyx_t_2;
      goto __pyx_L26_bool_binop_done;
    }
    __pyx_t_2 = (((__pyx_v_line[(__pyx_v_i - 5)]) == 82) != 0);
    __pyx_t_1 = __pyx_t_2;
    __pyx_L26_bool_binop_done:;
    if (__pyx_t_1) {

      /* "dream_net/sgf.pyx":87
 *                 count += 1
 *         elif line[i] == 100 and line[i-1] == 103 and line[i-2] == 105 and line[i-3] == 115 and line[i-4] == 101 and line[i-5] == 82:  # `Resign`
 *             resigned = 1             # <<<<<<<<<<<<<<
 * 
 ...
 *         x[count+1] = 19
 */
  __pyx_t_2 = ((__pyx_v_resigned == 0) != 0);
  if (__pyx_t_2) {
  } else {
    __pyx_t_1 = __pyx_t_2;
  ...
  __pyx_t_2 = (((__pyx_v_x[(__pyx_v_count - 1)]) != 19) != 0);
  if (__pyx_t_2) {
  } else {
    __pyx_t_1 = __pyx_t_2;
    goto __pyx_L33_bool_binop_done;
  }
  __pyx_t_2 = (((__pyx_v_y[(__pyx_v_count - 1)]) != 19) != 0);
  __pyx_t_1 = __pyx_t_2;
  __pyx_L33_bool_binop_done:;
  if (__pyx_t_1) {

    /* "dream_net/sgf.pyx":95
 *     # pass
 *     if resigned == 0 and count > 2 and x[count-1] != 19 and y[count-1] != 19:
 *         x[count+0] = 19             # <<<<<<<<<<<<<<
 *         x[count+1] = 19
 *         y[count+0] = 19
 */
    (__pyx_v_x[(__pyx_v_count + 0)]) = 19;

    /* "dream_net/sgf.pyx":96
 *     if resigned == 0 and count > 2 and x[count-1] != 19 and y[count-1] != 19:
 *         x[count+0] = 19
 *         x[count+1] = 19             # <<<<<<<<<<<<<<
 *         y[count+0] = 19
 *         y[count+1] = 19
 */
    (__pyx_v_x[(__pyx_v_count + 1)]) = 19;

    /* "dream_net/sgf.pyx":97
 *         x[count+0] = 19
 *         x[count+1] = 19
 *         y[count+0] = 19             # <<<<<<<<<<<<<<
 *         y[count+1] = 19
 * 
 */
    (__pyx_v_y[(__pyx_v_count + 0)]) = 19;

    /* "dream_net/sgf.pyx":98
 *         x[count+1] = 19
 *         y[count+0] = 19
 *         y[count+1] = 19             # <<<<<<<<<<<<<<
 * 
 ...
 */
    (__pyx_v_y[(__pyx_v_count + 1)]) = 19;

    /* "dream_net/sgf.pyx":100
 *         y[count+1] = 19
 * 
 *         color[count+0] = opposite(color[count-1])             # <<<<<<<<<<<<<<
 ...
 *         count += 2
 */
    (__pyx_v_color[(__pyx_v_count + 0)]) = __pyx_f_9dream_net_5rules_5color_opposite((__pyx_v_color[(__pyx_v_count - 1)]), 0);

    /* "dream_net/sgf.pyx":101
 * 
 *         color[count+0] = opposite(color[count-1])
 *         color[count+1] = color[count-1]             # <<<<<<<<<<<<<<
 *         count += 2
 * 
 */
    (__pyx_v_color[(__pyx_v_count + 1)]) = (__pyx_v_color[(__pyx_v_count - 1)]);

    /* "dream_net/sgf.pyx":102
 *         color[count+0] = opposite(color[count-1])
 *         color[count+1] = color[count-1]
 *         count += 2             # <<<<<<<<<<<<<<
 * 
...
static int __pyx_f_9dream_net_3sgf__one(unsigned char const *__pyx_v_line, int const __pyx_v_line_length, struct __pyx_obj_9dream_net_5rules_5board_Board *__pyx_v_board, int *__pyx_v_winner, int *__pyx_v_next1_color, int *__pyx_v_next1_logits) {
  int *__pyx_v_color;
  int *__pyx_v_x;
  int *__pyx_v_y;
  int __pyx_v_total_moves;
  int __pyx_v_pluck_move;
  int __pyx_v_index;
  int __pyx_v_i;
  int __pyx_r;
  int __pyx_t_1;
 ...
 */
  __pyx_v_color = ((int *)malloc(((sizeof(int)) * __Pyx_div_long(__pyx_v_line_length, 5))));

  /* "dream_net/sgf.pyx":123
 *     #
 *     cdef int *color = <int*>malloc(sizeof(int) * (line_length / 5))
 *     cdef int *x = <int*>malloc(sizeof(int) * (line_length / 5))             # <<<<<<<<<<<<<<
 *     cdef int *y = <int*>malloc(sizeof(int) * (line_length / 5))
 ...
 */
  __pyx_v_x = ((int *)malloc(((sizeof(int)) * __Pyx_div_long(__pyx_v_line_length, 5))));

  /* "dream_net/sgf.pyx":124
 *     cdef int *color = <int*>malloc(sizeof(int) * (line_length / 5))
 *     cdef int *x = <int*>malloc(sizeof(int) * (line_length / 5))
 *     cdef int *y = <int*>malloc(sizeof(int) * (line_length / 5))             # <<<<<<<<<<<<<<
 *     cdef int symmetry_index, total_moves, pluck_move, index, i
 * 
 */
  __pyx_v_y = ((int *)malloc(((sizeof(int)) * __Pyx_div_long(__pyx_v_line_length, 5))));

  /* "dream_net/sgf.pyx":127
 *     cdef int symmetry_index, total_moves, pluck_move, index, i
 * 
 *     try:             # <<<<<<<<<<<<<<
 ...
 *         #if total_moves <= 20:
 */
    __pyx_v_total_moves = __pyx_f_9dream_net_3sgf_gather_moves(__pyx_v_line, __pyx_v_line_length, __pyx_v_color, __pyx_v_x, __pyx_v_y, __pyx_v_winner);

    /* "dream_net/sgf.pyx":142
 ...
 */
    __pyx_v_pluck_move = ((int)(__pyx_v_total_moves * __pyx_f_9dream_net_3sgf_random()));

    /* "dream_net/sgf.pyx":144
 *         pluck_move = <int>(total_moves * random())
 * 
 *         for i in range(pluck_move):             # <<<<<<<<<<<<<<
 ...
 *                 index = 19 * y[i] + x[i]
 */
    __pyx_t_1 = __pyx_v_pluck_move;
    __pyx_t_2 = __pyx_t_1;
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      __pyx_v_i = __pyx_t_3;

      /* "dream_net/sgf.pyx":145
 * 
 *         for i in range(pluck_move):
 *             if x[i] < 19 and y[i] < 19:  # not pass             # <<<<<<<<<<<<<<
 *                 index = 19 * y[i] + x[i]
 * 
 */
      __pyx_t_5 = (((__pyx_v_x[__pyx_v_i]) < 19) != 0);
      if (__pyx_t_5) {
      } else {
        __pyx_t_4 = __pyx_t_5;
        goto __pyx_L9_bool_binop_done;
      }
      __pyx_t_5 = (((__pyx_v_y[__pyx_v_i]) < 19) != 0);
      __pyx_t_4 = __pyx_t_5;
      __pyx_L9_bool_binop_done:;
      if (__pyx_t_4) {

        /* "dream_net/sgf.pyx":146
 *         for i in range(pluck_move):
 *             if x[i] < 19 and y[i] < 19:  # not pass
 *                 index = 19 * y[i] + x[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_v_index = ((19 * (__pyx_v_y[__pyx_v_i])) + (__pyx_v_x[__pyx_v_i]));

        /* "dream_net/sgf.pyx":148
 *                 index = 19 * y[i] + x[i]
 * 
 *                 if board._is_valid(color[i], index):             # <<<<<<<<<<<<<<
 ...
 *                 else:
 */
        __pyx_t_4 = (((struct __pyx_vtabstruct_9dream_net_5rules_5board_Board *)__pyx_v_board->__pyx_vtab)->_is_valid(__pyx_v_board, (__pyx_v_color[__pyx_v_i]), __pyx_v_index) != 0);
        if (__pyx_t_4) {

          /* "dream_net/sgf.pyx":149
 * 
 *                 if board._is_valid(color[i], index):
 *                     board._place(color[i], index)             # <<<<<<<<<<<<<<
 *                 else:
 *                     return 0
 */
          ((struct __pyx_vtabstruct_9dream_net_5rules_5board_Board *)__pyx_v_board->__pyx_vtab)->_place(__pyx_v_board, (__pyx_v_color[__pyx_v_i]), __pyx_v_index);
 ...
 *         if x[pluck_move] < 19:
 */
    (__pyx_v_next1_color[0]) = (__pyx_v_color[__pyx_v_pluck_move]);

    /* "dream_net/sgf.pyx":158
 *         next1_color[0] = color[pluck_move]
 * 
 *         if x[pluck_move] < 19:             # <<<<<<<<<<<<<<
 ...
 *         else:
 */
    __pyx_t_4 = (((__pyx_v_x[__pyx_v_pluck_move]) < 19) != 0);
    if (__pyx_t_4) {

      /* "dream_net/sgf.pyx":159
 * 
 *         if x[pluck_move] < 19:
 *             next1_logits[0] = 19 * y[pluck_move] + x[pluck_move]             # <<<<<<<<<<<<<<
 *         else:
 *             next1_logits[0] = 361
 */
      (__pyx_v_next1_logits[0]) = ((19 * (__pyx_v_y[__pyx_v_pluck_move])) + (__pyx_v_x[__pyx_v_pluck_move]));
 ...
 */
    /*else*/ {
      (__pyx_v_next1_logits[0]) = 0x169;
    }
    __pyx_L12:;

    /* "dream_net/sgf.pyx":163
 *             next1_logits[0] = 361
 * 
 *         return 1             # <<<<<<<<<<<<<<
 *     finally:
...
/* Python wrapper */
static PyObject *__pyx_pw_9dream_net_3sgf_1one(PyObject *__pyx_self, PyObject *__pyx_v_line); /*proto*/
static PyMethodDef __pyx_mdef_9dream_net_3sgf_1one = {"one", (PyCFunction)__pyx_pw_9dream_net_3sgf_1one, METH_O, 0};
static PyObject *__pyx_pw_9dream_net_3sgf_1one(PyObject *__pyx_self, PyObject *__pyx_v_line) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("one (wrapper)", 0);
  __pyx_r = __pyx_pf_9dream_net_3sgf_one(__pyx_self, ((PyObject *)__pyx_v_line));
...
static PyObject *__pyx_pf_9dream_net_3sgf_one(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_line) {
  struct __pyx_obj_9dream_net_5rules_5board_Board *__pyx_v_board = 0;
  unsigned char *__pyx_v_line_ptr;
  int __pyx_v_line_length;
  int __pyx_v_result;
  int __pyx_v_winner;
  int __pyx_v_next1_color;
  int __pyx_v_next1_logits;
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_CallNoArg(((PyObject *)__pyx_ptype_9dream_net_5rules_5board_Board)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 170, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_board = ((struct __pyx_obj_9dream_net_5rules_5board_Board *)__pyx_t_1);
  __pyx_t_1 = 0;

  /* "dream_net/sgf.pyx":173
 * 
 *     # release the GIL (Global Interpreter Lock) while parsing the SGF file
 ...
 */
  __pyx_t_2 = __Pyx_PyObject_AsWritableUString(__pyx_v_line); if (unlikely((!__pyx_t_2) && PyErr_Occurred())) __PYX_ERR(0, 173, __pyx_L1_error)
  __pyx_v_line_ptr = ((unsigned char *)__pyx_t_2);

  /* "dream_net/sgf.pyx":174
 *     # release the GIL (Global Interpreter Lock) while parsing the SGF file
 *     cdef unsigned char *line_ptr = <unsigned char*>line
 *     cdef int line_length = len(line)             # <<<<<<<<<<<<<<
 *     cdef int result, winner, next1_color, next1_logits
 * 
 */
  __pyx_t_3 = PyObject_Length(__pyx_v_line); if (unlikely(__pyx_t_3 == ((Py_ssize_t)-1))) __PYX_ERR(0, 174, __pyx_L1_error)
  __pyx_v_line_length = __pyx_t_3;

  /* "dream_net/sgf.pyx":177
 *     cdef int result, winner, next1_color, next1_logits
 * 
 *     with nogil:             # <<<<<<<<<<<<<<
 ...
 *     if result == 0:
 */
        __pyx_v_result = __pyx_f_9dream_net_3sgf__one(__pyx_v_line_ptr, __pyx_v_line_length, __pyx_v_board, (&__pyx_v_winner), (&__pyx_v_next1_color), (&__pyx_v_next1_logits));
      }
 ...
 */
  ...
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_asarray); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 183, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  if (((__pyx_v_winner == __pyx_v_next1_color) != 0)) {
    __Pyx_INCREF(__pyx_float_1_0);
    __pyx_t_5 = __pyx_float_1_0;
  } else {
    __Pyx_INCREF(__pyx_float_neg_1_0);
    __pyx_t_5 = __pyx_float_neg_1_0;
  }
  ...
  if (PyFunction_Check(__pyx_t_6)) {
    PyObject *__pyx_temp[3] = {__pyx_t_5, __pyx_t_7, __pyx_n_s_f2};
    __pyx_t_1 = __Pyx_PyFunction_FastCall(__pyx_t_6, __pyx_temp+1-__pyx_t_8, 2+__pyx_t_8); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 183, __pyx_L1_error)
  ...
  if (__Pyx_PyFastCFunction_Check(__pyx_t_6)) {
    PyObject *__pyx_temp[3] = {__pyx_t_5, __pyx_t_7, __pyx_n_s_f2};
    __pyx_t_1 = __Pyx_PyCFunction_FastCall(__pyx_t_6, __pyx_temp+1-__pyx_t_8, 2+__pyx_t_8); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 183, __pyx_L1_error)
    __Pyx_XDECREF(__pyx_t_5); __pyx_t_5 = 0;
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  } else
  #endif
  {
    ...
    PyTuple_SET_ITEM(__pyx_t_9, 1+__pyx_t_8, __pyx_n_s_f2);
    __pyx_t_7 = 0;
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_6, __pyx_tuple__2, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 184, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_v_policy = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "dream_net/sgf.pyx":185
 *     value = np.asarray([1.0 if winner == next1_color else -1.0], 'f2')
 *     policy = np.zeros((362,), 'f2')
 *     policy[next1_logits] = 1.0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  if (unlikely(__Pyx_SetItemInt(__pyx_v_policy, __pyx_v_next1_logits, __pyx_float_1_0, int, 1, __Pyx_PyInt_From_int, 0, 1, 1) < 0)) __PYX_ERR(0, 185, __pyx_L1_error)

  /* "dream_net/sgf.pyx":187
 *     policy[next1_logits] = 1.0
 * 
 *     return (board, next1_color, value, policy)             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_next1_color); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 187, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  PyTuple_SET_ITEM(__pyx_t_6, 0, ((PyObject *)__pyx_v_board));
  ...
  PyTuple_SET_ITEM(__pyx_t_6, 3, __pyx_v_policy);
  __pyx_t_1 = 0;
  __pyx_r = __pyx_t_6;
  __pyx_t_6 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("dream_net.sgf.one", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
...
static int __pyx_pymod_exec_sgf(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_sgf},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_dream_net_sgf, __pyx_k_dream_net_sgf, sizeof(__pyx_k_dream_net_sgf), 0, 0, 1, 1},
  {&__pyx_kp_s_dream_net_sgf_pyx, __pyx_k_dream_net_sgf_pyx, sizeof(__pyx_k_dream_net_sgf_pyx), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_line_ptr, __pyx_k_line_ptr, sizeof(__pyx_k_line_ptr), 0, 0, 1, 1},
  {&__pyx_n_s_main, __pyx_k_main, sizeof(__pyx_k_main), 0, 0, 1, 1},
  {&__pyx_kp_u_ndarray_is_not_C_contiguous, __pyx_k_ndarray_is_not_C_contiguous, sizeof(__pyx_k_ndarray_is_not_C_contiguous), 0, 1, 0, 0},
  {&__pyx_kp_u_ndarray_is_not_Fortran_contiguou, __pyx_k_ndarray_is_not_Fortran_contiguou, sizeof(__pyx_k_ndarray_is_not_Fortran_contiguou), 0, 1, 0, 0},
  {&__pyx_n_s_next1_color, __pyx_k_next1_color, sizeof(__pyx_k_next1_color), 0, 0, 1, 1},
  {&__pyx_n_s_next1_logits, __pyx_k_next1_logits, sizeof(__pyx_k_next1_logits), 0, 0, 1, 1},
 ...
 * 
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_int_362); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 184, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple_);
  __Pyx_GIVEREF(__pyx_tuple_);
  __pyx_tuple__2 = PyTuple_Pack(2, __pyx_tuple_, __pyx_n_s_f2); if (unlikely(!__pyx_tuple__2)) __PYX_ERR(0, 184, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__12 = PyTuple_Pack(10, __pyx_n_s_line, __pyx_n_s_board, __pyx_n_s_line_ptr, __pyx_n_s_line_length, __pyx_n_s_result, __pyx_n_s_winner, __pyx_n_s_next1_color, __pyx_n_s_next1_logits, __pyx_n_s_value, __pyx_n_s_policy); if (unlikely(!__pyx_tuple__12)) __PYX_ERR(0, 169, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__12);
  __Pyx_GIVEREF(__pyx_tuple__12);
  __pyx_codeobj__13 = (PyObject*)__Pyx_PyCode_New(1, 0, 10, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__12, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_dream_net_sgf_pyx, __pyx_n_s_one, 169, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__13)) __PYX_ERR(0, 169, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
static int __Pyx_modinit_type_import_code(void) {
  ...
  __pyx_ptype_9dream_net_5rules_5board_Board = __Pyx_ImportType("dream_net.rules.board", "Board", sizeof(struct __pyx_obj_9dream_net_5rules_5board_Board), 1); if (unlikely(!__pyx_ptype_9dream_net_5rules_5board_Board)) __PYX_ERR(3, 3, __pyx_L1_error)
  __pyx_vtabptr_9dream_net_5rules_5board_Board = (struct __pyx_vtabstruct_9dream_net_5rules_5board_Board*)__Pyx_GetVtable(__pyx_ptype_9dream_net_5rules_5board_Board->tp_dict); if (unlikely(!__pyx_vtabptr_9dream_net_5rules_5board_Board)) __PYX_ERR(3, 3, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initsgf(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initsgf(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_sgf(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_sgf(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_sgf(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_sgf(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("sgf", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_dream_net__sgf) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "dream_net.sgf")) {
      if (unlikely(PyDict_SetItemString(modules, "dream_net.sgf", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 * 
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_9dream_net_3sgf_1one, NULL, __pyx_n_s_dream_net_sgf); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 169, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_one, __pyx_t_1) < 0) __PYX_ERR(0, 169, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init dream_net.sgf", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init dream_net.sgf");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
